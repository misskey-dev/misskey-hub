import{_ as n,o as s,c as a,e}from"./app.e47557b3.js";const i={},t=e(`<h1 id="nginx-configuration-example" tabindex="-1"><a class="header-anchor" href="#nginx-configuration-example" aria-hidden="true">#</a> Nginx configuration example</h1><div class="language-nginx ext-nginx line-numbers-mode"><pre class="language-nginx"><code><span class="token comment"># Sample nginx configuration for Misskey</span>
