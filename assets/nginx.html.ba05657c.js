import{e as n}from"./app.43cb4708.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=n(`<h1 id="nginx\u8A2D\u5B9A\u4F8B" tabindex="-1"><a class="header-anchor" href="#nginx\u8A2D\u5B9A\u4F8B" aria-hidden="true">#</a> Nginx\u8A2D\u5B9A\u4F8B</h1><div class="language-nginx ext-nginx line-numbers-mode"><pre class="language-nginx"><code><span class="token comment"># Sample nginx configuration for Misskey</span>
