import{e as n}from"./app.ed093c36.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=n(`<h1 id="nginx-configuration-example" tabindex="-1"><a class="header-anchor" href="#nginx-configuration-example" aria-hidden="true">#</a> Nginx configuration example</h1><div class="language-nginx ext-nginx line-numbers-mode"><pre class="language-nginx"><code><span class="token comment"># Sample nginx configuration for Misskey</span>
