<template>
	<div id="root">
		<div class="bg">
			<div v-parallax="1.2" class="object1">
				<img src="/top-bg-object1.svg" alt="Blob" />
			</div>
			<div v-parallax="1.2" class="object2">
				<img src="/top-bg-object2.svg" alt="Blob" />
			</div>
			<div v-parallax="1.2" class="object3">
				<img src="/top-bg-object2.svg" alt="Blob" />
			</div>
		</div>
		...
		<div class="top">
			...
			<div class="container">
				...
				>
					<g
						id="path2"
						transform="matrix(0.264585,0,0,0.264585,-50.0005,-50.0001)"
					>
						<path
				...
				<div class="buttons">
					<a class="start" href="#gettingStarted">{{
						frontmatter.gettingStarted
					}}</a>
			...
			/>
			<img v-parallax="4" src="/ai.png" class="ai" alt="Ai-chan!" />
			<a
				...
				><svg
					...
					height="80"
					viewBox="0 0 250 250"
					style="position: fixed; z-index: 10; top: 0; border: 0; right: 0"
					aria-hidden="true"
				>
		...
		<div class="key-features">
			<div class="container">
				<div class="item">
					<div class="icon">
						<img src="/emojis/four-leaf-clover_1f340.png" alt="4 leaf clover" />
					</div>
					<div class="title">{{ frontmatter.keyFeatures.open.title }}</div>
					<div class="description">
						{{ frontmatter.keyFeatures.open.description }}
					</div>
				</div>
				<div class="item">
					<div class="icon">
						<img src="/emojis/ringed-planet_1fa90.png" alt="Ringed planet" />
					</div>
					<div class="title">{{ frontmatter.keyFeatures.federated.title }}</div>
					<div class="description">
						{{ frontmatter.keyFeatures.federated.description }}
					</div>
				</div>
				<div class="item">
					<div class="icon">
						<img src="/emojis/package_1f4e6.png" alt="Box" />
					</div>
					<div class="title">
						{{ frontmatter.keyFeatures.multifunction.title }}
					</div>
					<div class="description">
						{{ frontmatter.keyFeatures.multifunction.description }}
					</div>
				</div>
				<div class="item">
					<div class="icon">
						<img src="/emojis/gear_2699-fe0f.png" alt="Gear" />
					</div>
					<div class="title">
						{{ frontmatter.keyFeatures.customizable.title }}
					</div>
					<div class="description">
						{{ frontmatter.keyFeatures.customizable.description }}
					</div>
				</div>
			</div>
		</div>
		...
		<div class="body">
			<div class="about" id="learnMore">
				<div class="container">
					<div
						class="title"
						v-html="frontmatter.sections.federatedSoftware.title"
					></div>
					<div
						class="description"
						v-html="frontmatter.sections.federatedSoftware.description"
					></div>
				</div>
			</div>
				...
				<div class="container">
					<div class="h">
						<div class="container">
							...
							<div class="text">
								{{ frontmatter.sections.features.description }}
							</div>
						</div>
					</div>
					<div class="list">
						<div class="column">
							<div v-fade-in class="item">
								<div class="content">
									<img src="/top-features-note.png" class="img" alt="Notes" />
									<div class="title">
										{{ frontmatter.sections.features.list.note.title }}
									</div>
									<div class="description">
										{{ frontmatter.sections.features.list.note.description }}
									</div>
								</div>
							</div>
							<div v-fade-in class="item">
								<div class="content">
									<img
										src="/top-features-reaction.png"
										class="img"
										alt="Reactions"
									/>
									<div class="title">
										{{ frontmatter.sections.features.list.reaction.title }}
									</div>
									<div class="description">
										{{
											frontmatter.sections.features.list.reaction.description
										}}
									</div>
								</div>
							</div>
							<div v-fade-in class="item">
								<div class="content">
									<img src="/top-features-theme.png" class="img" alt="Themes" />
									<div class="title">
										{{ frontmatter.sections.features.list.theme.title }}
									</div>
									<div class="description">
										{{ frontmatter.sections.features.list.theme.description }}
									</div>
								</div>
							</div>
							<div v-fade-in class="item">
								<div class="content">
									<img
										src="/top-features-charts.png"
										class="img"
										alt="Charts"
									/>
									<div class="title">
										{{ frontmatter.sections.features.list.charts.title }}
									</div>
									<div class="description">
										{{ frontmatter.sections.features.list.charts.description }}
									</div>
								</div>
							</div>
						</div>
						<div class="column">
							<div v-fade-in class="item">
								<div class="content">
									...
									/>
									<div class="title">
										{{ frontmatter.sections.features.list.federation.title }}
									</div>
									<div class="description">
										{{
							...
							<div v-fade-in class="item">
								<div class="content">
									<img src="/top-features-drive.png" class="img" alt="Drive" />
									<div class="title">
										{{ frontmatter.sections.features.list.drive.title }}
									</div>
									<div class="description">
										{{ frontmatter.sections.features.list.drive.description }}
									</div>
								</div>
							</div>
							<div v-fade-in class="item">
								<div class="content">
									<img
										src="/top-features-thread.png"
										class="img"
										alt="Threads"
									/>
									<div class="title">
										{{ frontmatter.sections.features.list.thread.title }}
									</div>
									<div class="description">
				...
				<div class="container">
					<div v-fade-in class="find">
						<div class="container">
							<div class="icon">
								<img
									src="/emojis/ringed-planet_1fa90.png"
									alt="Ringed planet"
								/>
							</div>
							<div class="title">
							...
							<a class="link" href="./instances.html">{{
					...
					<div v-fade-in class="create">
						<div class="container">
							...
							<div class="description"></div>
							<a class="link" href="./docs/install.html">{{
					...
					<div v-fade-in class="docs">
						<div class="container">
							<div class="icon">
								<img src="/emojis/light-bulb_1f4a1.png" alt="Lightbulb" />
							</div>
							<div class="title">
								{{ frontmatter.sections.gettingStarted.docs.title }}
							</div>
							<div class="description"></div>
							<a class="link" href="/docs/getting-started.html">{{
			...
			<div class="donation">
				<div class="container">
					...
					<div class="description">
						{{ frontmatter.sections.donation.description }}
					</div>
					<a class="patreon" href="https://www.patreon.com/syuilo"
						><img
			...
			<div class="supporters">
				<div class="container">
					...
					<a class="rss3" title="RSS3" href="https://rss3.io/" target="_blank"
						><img src="/sponsors/rss3.svg" alt="RSS3"
					/></a>
				</div>
			</div>
		</div>
