        ...
        locales: {
            ...
            '/zh-TW/': {
                ...
                '/pl/': {
                    ...
                    editLinkText: 'Edytuj tą stronę',
                    relatedPagesText: 'Powiązane strony',
                    readThisArticle: 'Przeczytaj ten artykuł',
                    navbar: [
                        { text: 'Blog', link: '/pl/blog/' },
                        { text: 'Taking part', children: ['/pl/instances', '/pl/plugins/', '/pl/appendix/assets'] },
                        {
